document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener('resize', () => {
    ...
    if ($(window).width() > '1024') {
      searchBurger.classList.add('header__searchform--close');
      // document.querySelector('.header__burger').style.visibility = "hidden";
    }

    if (priznak == 0 && $(window).width() > '1024') {
      search.classList.add('header__searchform--close');
    ...
    if (priznak == 1 && $(window).width() <= '992') {
      ...
      searchBurger.classList.add('header__searchform--close');
      searchLogo.classList.add('header__searchform--close');
      search.classList.add('header__searchform--close');
  ...
  searchClose.addEventListener('click', (el) => {
    ...
    if ($(window).width() <= '1024' && $(window).width() > '992') {
      ...
      // function delay1024() {
        ...
        // }
      // window.setTimeout(delay1024, 600);
      priznak = 0;
    };
